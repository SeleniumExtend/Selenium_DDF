...
public class TestBase {
	...
	public void click(String locator) {
		...
		if (locator.endsWith("_CSS")) {
			...
			CustomListeners.testReport.get().log(Status.INFO, "Clicking on CSS: " + locator + OR.getProperty(locator));
		} else if (locator.endsWith("_XPATH")) {
			driver.findElement(By.xpath(OR.getProperty(locator))).click();
			CustomListeners.testReport.get().log(Status.INFO, "Clicking on XPATH: " + locator + OR.getProperty(locator));
		} else if (locator.endsWith("_ID")) {
			driver.findElement(By.id(OR.getProperty(locator))).click();
			CustomListeners.testReport.get().log(Status.INFO, "Clicking on ID: " + locator + OR.getProperty(locator));
		}
