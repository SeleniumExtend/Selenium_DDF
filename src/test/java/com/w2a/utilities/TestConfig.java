...
public class TestConfig{
	...
	public static String from = "subbanarapureddy@gmail.com";
	public static String password = "NV#sr@1915";
	public static String[] to ={"subbanarapureddy@gmail.com","nvsr4u@gmail.com"};
